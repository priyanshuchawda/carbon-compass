...
export const ASSISTANT_TOOLS = [
  {
    ...
    description:
      "Retrieve detailed emission metrics and input values for a specific category (transport, energy, food, shopping, waste). Use this to understand specific drivers.",
    parameters: {
      type: "OBJECT",
      properties: {
        category: {
  ...
  },
  {
    ...
    description:
      "Compare the user's monthly carbon emissions against the national Indian average (both per-capita and household adjusted).",
    parameters: {
      type: "OBJECT",
      properties: {
        monthlyKg: {
  ...
  },
  {
    ...
    description:
      "Simulate the carbon emissions impact (savings in kg CO2e/month) of taking a specific action.",
    parameters: {
      type: "OBJECT",
      properties: {
        actionId: {
